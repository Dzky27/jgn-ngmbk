let messages = ["Please?", "Kasih aku kesempatan!", "Yakin deck?", "Yakin Nich?", "Coba pikir sekali lagi", "Jgn Ngambek Plis", "Cantikkk???", "Hati Moengil ku terpoteq 💔"];
let noCount = 0;
...
function acceptLove() {
    document.getElementById("valentine").innerHTML = `
        ...
        <div class="question">YEAYYY DIMAAPIN AHAHAHHA</div>
    `;
    launchConfetti();
    startHeartRain();
}
